...
CREATE TABLE `food` (
  ...
  `fodmap` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `oligos` int DEFAULT NULL,
  `fructose` int DEFAULT NULL,
  `polyols` int DEFAULT NULL,
  `lactose` int DEFAULT NULL
...
(190, 8, 'Golden syrup / light tracle', 'low', NULL, NULL, NULL, NULL),
(191, 3, 'Granola', 'high', NULL, NULL, NULL, NULL),
(192, 5, 'Grapefruit', 'high', 2, 0, 0, 0),
(193, 5, 'Grapes (Red, Green and Black)', 'low', 0, 0, 0, 0),
(194, 1, 'Greek yogurt', 'low', NULL, NULL, NULL, NULL),
...
(283, 7, 'Sodas with HFCS', 'high', NULL, NULL, NULL, NULL),
